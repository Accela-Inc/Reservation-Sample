...
declare class KinsailRecServer implements RecreationServer {
    private http;
    private config;
    private domain;
    private port;
    ...
    public getSiteAttributeList(): FeatureAttribute<any>[];
    public siteTypes: FeatureAttribute<any>[];
    public getSiteTypeList(): FeatureAttribute<any>[];
    public shadeTypes: FeatureAttribute<ShadeType>[];
    public getShadeType(): FeatureAttribute<ShadeType>[];
    public getLocationDetail(locationObjectId: number, callback: ASyncReply<LocationDetail>): void;
    ...
    public getSiteAvailability(siteObjectId: number, callback: ASyncReply<SiteAvailability>): void;
